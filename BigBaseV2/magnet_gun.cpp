...
#include "scroll.h"
#include "util.h"
using namespace big::weapon::magnet_gun::vars;
...
namespace big::menu
{
	...
	void magnet_gun_menu::menu()
	{
		using namespace ui;

		m_renderer.new_sub<sub>("Magnet Gun", SubMagnetGun, [](sub* core)
			{
	...
	void magnet_gun_menu::script_init() {}

	void magnet_gun_menu::script_on_tick()
	{
	...
	void magnet_gun_menu::script_func()
	{
		m_magnet_gun_menu.script_init();
		while (true)
		{
