...
#include "scroll.h"
#include "lists.h"
using namespace big::player::proofs::vars;
...
namespace big::menu
{
	...
	void proofs_menu::menu()
	{
		using namespace ui;



		m_renderer.new_sub<sub>("Proofs", SubProofs, [](sub* core)
			{
	...
	void proofs_menu::script_init() {}

	void proofs_menu::script_on_tick()
	{
	...
	void proofs_menu::script_func()
	{
		m_proofs_menu.script_init();
		while (true)
		{
